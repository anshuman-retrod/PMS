...
export const ratePlans: RatePlan[] = [
  ...
  },
  {
    ...
    description: "Best price for prepaid, non-refundable bookings.",
    benefits: ["Lower rate", "Early check-in priority if available"],
    policyId: "policy-nr",
    discountPercent: 12,
    status: "Active",
  },
  {
    id: "rate-corp",
    name: "Corporate Rate",
    description: "Negotiated business traveler rate.",
    benefits: ["Invoice support", "Corporate amenities"],
  ...
  },
  {
    id: "rate-weekend",
    name: "Weekend Rate",
    description: "Fri-Sun promotional pricing.",
  ...
  },
  {
    ...
    description: "Advance purchase discounted rate.",
    benefits: ["Discounted ADR"],
    policyId: "policy-nr",
    discountPercent: 18,
    status: "Active",
  },
  {
    id: "rate-long-stay",
    name: "Long Stay Rate",
    description: "Extended stay pricing benefits.",
    benefits: ["Laundry credit", "F&B credit"],
    policyId: "policy-flex",
    discountPercent: 20,
    status: "Active",
  },
