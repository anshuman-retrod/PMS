...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  ...
  front_office_manager: allOf(
    ...
    "frontdesk.view","frontdesk.checkin","frontdesk.checkout","frontdesk.roommove",
    "guests.view","guests.edit","guests.communicate",
    "loyalty.view","registration.view","guestrequests.view","feedback.view","lostfound.view",
    "tasks.view","concierge.view","transport.view","activities.view",
    "housekeeping.view","maintenance.view",
    "groups.view","corporate.view","packages.view","addons.view",
  ...
  front_desk_agent: allOf(
    ...
    "guests.view","guests.communicate","guestrequests.view","lostfound.view","concierge.view",
    "housekeeping.view","maintenance.view",
  ...
  housekeeping_supervisor: allOf(
    "dashboard.view",
    "housekeeping.view","housekeeping.assign","housekeeping.status",
    "maintenance.view","maintenance.manage","tasks.view",
    "rooms.manage",
    "staff.manage",
  ),
  accounts: allOf(
  ...
  revenue_manager: allOf(
    "dashboard.view",
    "revenue.view","revenue.editrates","pricing.view","pricing.manage","ota.manage",
    "groups.view","corporate.view","packages.view","bookingengine.view","addons.view",
    "reservations.view",
    "reports.view","reports.export","ai.view","analytics.executive",
  ),
};
