...
const logs = [
  {
    ts: "15 May 2026 · 11:42:18",
    user: "Aarav Malhotra",
    role: "GM",
    action: "Confirmed reservation RES-2048",
    ip: "10.4.2.18",
  },
  {
    ts: "15 May 2026 · 11:18:02",
    user: "Front Desk · Neha",
    role: "Front Desk",
    action: "Captured payment ₹48,000 · INV-3104",
    ip: "10.4.2.31",
  },
  {
    ts: "15 May 2026 · 10:55:44",
    user: "Priya · Housekeeping",
    role: "HK",
    action: "Marked Room 215 as Inspected",
    ip: "10.4.2.74",
  },
  {
    ts: "15 May 2026 · 10:32:09",
    user: "Front Desk · Neha",
    role: "Front Desk",
    action: "Checked-in Marcus Weber · Room 215",
    ip: "10.4.2.31",
  },
  {
    ts: "15 May 2026 · 09:48:22",
    user: "System",
    role: "Channel Mgr",
    action: "Updated rate: Booking.com · Deluxe King +₹600",
    ip: "system",
  },
  {
    ts: "15 May 2026 · 09:12:00",
    user: "Aarav Malhotra",
    role: "GM",
    action: "Updated user permissions for staff#42",
    ip: "10.4.2.18",
  },
];
...
export function AuditFeature() {
  ...
  const mergedLogs = [
    ...auditEvents.map((event) => ({
      ...
      action: event.detail ? `${event.action} · ${event.detail}` : event.action,
      ip: event.target ?? "n/a",
    })),
    ...logs,
  ];
  return (
    <div>
      <PageHeader
        ...
        title="Audit Logs"
        description="Every consequential action, recorded with timestamp and actor."
      />
      <div className="p-6">
        <Card>
